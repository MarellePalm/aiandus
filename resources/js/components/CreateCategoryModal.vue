        ...
        <div class="relative w-full max-w-lg rounded-3xl bg-card shadow-xl ring-1 ring-border">
          ...
          <div class="p-5 sm:p-6">
            ...
            <div class="flex items-start justify-between gap-3">
              <div>
                <h3 class="text-lg font-semibold text-foreground">Lisa uus kategooria</h3>
              ...
              >
                ...
                <template v-else>
                  <div class="flex flex-col items-center gap-4">
                    <div class="w-full aspect-[16/10] overflow-hidden rounded-2xl border border-border bg-background shadow-sm">
                      <img
                        v-if="previewUrl"
                        :src="previewUrl"
                        alt="Eelvaade"
            ...
            <div class="mt-6 flex flex-col gap-3">
              <button
                ...
                :class="form.name.trim().length ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'bg-black/10 text-foreground'"
