                    ...
                    <div class="max-h-[90vh] overflow-y-auto p-5 sm:p-6">
                        <div class="flex items-start justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-foreground/70">
                                    Vali kategooria, lisa sort, kuupäev ja soovi
                                    korral hooldusinfo ning foto.
                                </p>
                            </div>
                        ...
                        <main class="mt-5 flex flex-col gap-6">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <template v-else>
                                        ...
                                        >
                                            <div
                                                class="aspect-[16/10] w-full overflow-hidden rounded-2xl border border-border bg-background shadow-sm"
                                            >
                                                <img
                                                    v-if="previewUrl"
                                                    :src="previewUrl"
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-foreground/50">
                                    Näide: iga nädal, 2x nädalas, kui muld on
                                    kuiv
                                </p>
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-foreground/50">
                                    Valikuline. Kirjuta siia väetamise sagedus
                                    või juhis.
                                </p>
