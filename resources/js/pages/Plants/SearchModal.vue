        ...
        >
            ...
            >
                ...
                <div class="p-5 sm:p-6">
                    ...
                    <div class="mt-4 flex gap-2">
                        <div class="relative flex-1">
                            ...
                            <input
                                ...
                                v-model="query"
                                :placeholder="
                                    placeholder ?? 'Nt: kurk, tomat, till…'
                                "
                            ...
                            <div
                                v-if="matches.length"
                                class="absolute top-[calc(100%+8px)] right-0 left-0 z-10 overflow-hidden rounded-2xl border border-border bg-card shadow-lg"
                            >
                                <button
                                    v-for="m in matches"
                                    :key="m"
                            ...
                            <button
                                v-if="query.length"
                                class="absolute top-1/2 right-2 -translate-y-1/2 rounded-xl px-2 py-1 text-xs text-foreground/60 hover:bg-black/5"
                                @click="clear"
                                type="button"
                            >
                                Puhasta
                    ...
                    <div
                        class="mt-4 flex items-center justify-between text-xs text-foreground/60"
                    >
