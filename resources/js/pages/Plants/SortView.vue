          ...
          <main class="pb-24">
            ...
            <div class="px-4 py-6">
              <div class="no-scrollbar flex gap-3 overflow-x-auto pb-2">
                <button type="button" :class="tabClass('all')" @click="activeTab = 'all'">
                  Kõik taimed
                </button>
                <button type="button" :class="tabClass('growing')" @click="activeTab = 'growing'">
                  Kasvavad
                </button>
                <button type="button" :class="tabClass('harvest')" @click="activeTab = 'harvest'">
                  Saagikoristus
                </button>
              </div>
            </div>
                ...
                <div class="flex min-w-0 flex-1 flex-col justify-between py-0.5">
                  <div>
                    <div class="flex items-start justify-between gap-3">
                      ...
                      <button class="text-sm text-gray-300 hover:text-gray-400" type="button" aria-label="Rohkem">
                  ...
                  <div class="flex items-center gap-2">
                    <span class="h-2 w-2 rounded-full" :class="statusStyles(p.status).dot"></span>
                    <span
