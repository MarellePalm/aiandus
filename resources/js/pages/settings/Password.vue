...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Parooli seaded" />

        <h1 class="sr-only">Parooli seaded</h1>

        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall
                    title="Uuenda parool"
                    description="Kasuta pikka ja juhuslikku parooli, et konto oleks turvaline"
                />
