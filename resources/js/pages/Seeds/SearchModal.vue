                ...
                <div class="p-5 sm:p-6">
                    ...
                    <div class="mt-4 flex gap-2">
                        <div class="relative flex-1">
                            <span
                                class="absolute top-1/2 left-3 -translate-y-1/2 text-[#2E2E2E]/40"
                            >
                                🔎
                            </span>
                            <input
                            ...
                            <div
                                v-if="matches.length"
                                class="absolute top-[calc(100%+8px)] right-0 left-0 z-10 overflow-hidden rounded-2xl border border-black/10 bg-white shadow-lg"
                            >
                                <button
                                    v-for="m in matches"
                                    :key="m"
                            ...
                            <button
                                v-if="query.length"
                                class="absolute top-1/2 right-2 -translate-y-1/2 rounded-xl px-2 py-1 text-xs text-[#2E2E2E]/60 hover:bg-black/5"
                                @click="clear"
                                type="button"
                            >
                                Puhasta
                        ...
                        <button
                            ...
                            :class="
                                canSearch
                                    ? 'bg-[#6B8C68] text-white hover:bg-[#4F6A52]'
                                    : 'bg-black/10 text-[#2E2E2E]'
                            "
                            :disabled="!canSearch"
                            @click="submit"
                            type="button"
