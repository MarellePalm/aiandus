...
| `folkTiming.ts` | Pehme/kõva/mäda/kuiv — **päevapõhine** (`folkTimingForAgeDays`), mitte üks plokk lehe all. |
...
| `moonCopy.ts` | Avalehe sissejuhatus, jalus, pehme/kõva/mäda/kuiv plokid, kaardi märkus |
